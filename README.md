...
Replaces reactive PID cooling with a Physics-Informed Forecaster that predicts temperature spikes 30–60s ahead, eliminating thermal throttling and saving ~13% cooling energy.
...
|-----------|------|-------------|
| **Moss Context Engine** | `server/moss.ts` | Zero-vector-DB semantic retrieval engine delivering **sub-10ms** hardware specs and runbook lookups |
...
| **Physics-Informed Forecaster Engine** | `server/neuralflow.ts` | Physics-informed predictive horizon with MC uncertainty estimation (30-60s ahead) |
...
| **Real-Time Control Room** | `src/components/ControlRoom.tsx` | Live workload injector sliders, Physics-Informed Forecaster predictive horizon HUD, and dual cluster rack |
